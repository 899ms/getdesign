...
- **Developer surfaces** — API, CLI, SDK, and Skills. Their docs live on docs.getdesign.app. Settings links out to those pages and notes that v1 has no getdesign API key.
